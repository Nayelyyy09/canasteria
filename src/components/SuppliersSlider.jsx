  ...
  return (
    <section id="proveedores" className="bg-[#FAF7F2] py-20 lg:py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        >
          <p className="font-body text-xs tracking-[0.4em] uppercase text-[#7E0E0F] mb-3">
            Calidad garantizada
          </p>
          ...
          <p className="mt-4 font-body text-sm text-[#0A461A]/50 max-w-lg mx-auto">
      ...
      <div className="relative">
        ...
        >
          {doubled.map((supplier, i) => (
            <div
              key={i}
              className="flex-shrink-0 w-56 lg:w-64 bg-[#0A461A] border border-[#C9A96E]/20 p-6 flex flex-col items-center justify-center text-center"
            >
              <div className="w-12 h-12 rounded-full bg-[#7E0E0F]/20 border border-[#7E0E0F]/40 flex items-center justify-center mb-3">
