    ...
    <div className="bg-[#FAF7F2] min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 py-4">
        <nav className="flex items-center gap-2 font-body text-xs text-[#0A461A]/50">
          ...
          <span className="text-[#0A461A]">Términos y Condiciones</span>
        </nav>
      </div>
      ...
      <section className="relative overflow-hidden bg-[#0A461A] py-20 lg:py-28">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-16 text-center">
          ...
          <h1 className="font-display text-5xl lg:text-7xl text-[#FAF7F2] leading-tight">
            Términos y <span className="italic text-[#7E0E0F]">Condiciones</span>
          </h1>
      ...
      <section className="max-w-4xl mx-auto px-6 lg:px-16 py-20 lg:py-28">
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 flex items-center justify-center bg-[#7E0E0F]/10 border border-[#7E0E0F]/20">
              <FileText size={18} className="text-[#7E0E0F]" />
            </div>
          ...
          <div className="prose prose-lg max-w-none font-body text-[#0A461A]/70 leading-relaxed space-y-8">
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">1. Identificación del Prestador</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">2. Aceptación de los Términos</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">3. Productos y Servicios</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">4. Proceso de Compra</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">5. Precios y Pagos</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">6. Envíos y Entregas</h2>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">7. Devoluciones y Reembolsos</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">8. Facturación</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">9. Propiedad Intelectual</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">10. Limitación de Responsabilidad</h2>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">11. Protección de Datos Personales</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">12. Ley Aplicable y Jurisdicción</h2>
              <p>
            ...
            <div>
              <h2 className="font-display text-2xl text-[#0A461A] mb-3">13. Modificaciones</h2>
              <p>
